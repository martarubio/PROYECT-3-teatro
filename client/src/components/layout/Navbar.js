...
const Navigation = ({ loggedUser, storeUser }) => {
    ...
    return (
        ...
        <Navbar className="flex-column">
            <Container>
                <Navbar.Brand href="#home" style={{ background: 'rgb(131, 5, 5)', color: 'white', fontSize: '20px', justifyItems: 'center', fontFamily: 'Lobster cursive' }} >MadrizTeatro</Navbar.Brand>
